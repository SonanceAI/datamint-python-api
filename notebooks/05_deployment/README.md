...
| [05_local_docker_build](05_local_docker_build.ipynb) | ![Intermediate](https://img.shields.io/badge/level-intermediate-yellow) | Build and run a model image locally with `podman` as a pre-deployment sanity check, and predict against it without touching the server |
